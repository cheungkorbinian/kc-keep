...
本地 v90.2 修复重生位置、物品堆叠丢失、营火操作、冬季降温、武装资格与遗物拾取；详细说明见 game/README.md。

本地 v90.3 加入遗物地图标记、冬季预警、背包容量和独立手动存档。
本地 v90.4 加入敌人攻击预警、世界地图路标、目标奖励、死亡回顾和营地训练木桩。

本地 v90.5 加入自由选址建造、可登记家园、再生树苗、可持续采矿与首领解锁的回响试炼；完成里程碑后继续在原世界游玩。
